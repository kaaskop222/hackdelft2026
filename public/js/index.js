...
function msToTime(duration) {
    ...
    if (duration < 0)
        multiplier = -1;
    duration *= multiplier;
    var milliseconds = Math.floor((duration % 1000)), seconds = Math.floor((duration / 1000) % 60), minutes = Math.floor((duration / (1000 * 60)) % 60), hours = Math.floor((duration / (1000 * 60 * 60)) % 24);
...
function create_event_display(subtraction, description, user) {
}
// --------------------
// SERVER FUNCTIONS
// --------------------
